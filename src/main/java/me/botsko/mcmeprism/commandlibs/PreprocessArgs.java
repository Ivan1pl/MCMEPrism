...
public class PreprocessArgs {
     ...
     *
     */
    public static QueryParameters process(MCMEPrism plugin, CommandSender sender, String[] args,
    ...
    public static QueryParameters process(MCMEPrism plugin, CommandSender sender, String[] args,
        ...
        final HashMap<String, PrismParameterHandler> registeredParams = MCMEPrism.getParameters();
        ...
        for ( final MatchedParam matchedParam : foundArgsList ) {
            try {
                ...
                if( sender != null )
                    sender.sendMessage(MCMEPrism.messenger.playerError( e.getMessage() ) );
                return null;
            }
        }
     ...
     * @return
     */
    private static ParseResult parseParam(MCMEPrism plugin, CommandSender sender, QueryParameters parameters, HashMap<String, PrismParameterHandler> registeredParams, Set<String> foundArgsNames, List<MatchedParam> foundArgsList, String arg) {
        ...
        switch (result) {
            case NotFound:
                if (sender != null)
                    sender.sendMessage(MCMEPrism.messenger.playerError("Unrecognized parameter '" + arg
                            + "'. Use /prism ? for help."));
                break;
            case NoPermission:
                if (sender != null)
                    sender.sendMessage(MCMEPrism.messenger.playerError("No permission for parameter '" + arg + "', skipped."));
                break;
            default:
                break;
        }
