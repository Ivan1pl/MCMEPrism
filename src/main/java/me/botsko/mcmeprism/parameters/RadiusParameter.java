...
import me.botsko.mcmeprism.bridge.WorldEditBridge;
...
public class RadiusParameter extends SimplePrismParameterHandler {
    ...
    public void process(QueryParameters query, String alias, String input, CommandSender sender) {
        ...
        final FileConfiguration config = Bukkit.getPluginManager().getPlugin( "MCMEPrism" ).getConfig();
        ...
        if( TypeUtils.isNumeric( inputValue )
            ...
            if( desiredRadius != radius ) {
                if( sender != null )
                    sender.sendMessage(MCMEPrism.messenger.playerError( "Forcing radius to " + radius
