...
public class PrismCommands extends Executor {
     ...
     * @param prism
     */
    public PrismCommands(MCMEPrism prism) {
    ...
    private void setupCommands() {
        ...
        final MCMEPrism prism = (MCMEPrism) plugin;
        ...
        addSub( "reload", "prism.reload" ).allowConsole().setHandler(new SubHandler() {
            ...
            public void handle(CallInfo call) {
                prism.reloadConfig();
                call.getSender()
                        .sendMessage(MCMEPrism.messenger.playerHeaderMsg( "Configuration reloaded successfully." ) );
            }
